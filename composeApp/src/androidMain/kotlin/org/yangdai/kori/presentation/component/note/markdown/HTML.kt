...
val HTMLTemplate = $$"""
    ...
    <head>
        ...
        <link rel="stylesheet" href="/assets/prism/prism-theme-light.css"
              id="prism-light-theme">
        <link rel="stylesheet" href="/assets/prism/prism-theme-dark.css"
              id="prism-dark-theme">
    </head>
    <body>
    ...
    <script>
        const handlers = {
            ...
            processVideos: () => {
                document.querySelectorAll('video').forEach(video => {
                    ...
                    if (currentSrc && !currentSrc.includes('#t=0.1')) {
                        video.setAttribute('src', currentSrc + '#t=0.1');
                    }
        ...
        function updateMarkdownContent(newHtml) {
