            ...
            STATE_RELATIVE -> {
                ...
                if (c == '/') {
                    ...
                    if (c == '?') {
                        ...
                        // than here.
                        relativeNoSlash = base?.relativeNoSlash != false
                        if (path.isNotEmpty()) {
            ...
            STATE_AUTHORITY -> {
                if (c == '@') {
                    ...
                    for (it in buffer.toString()) {
                        ...
                        val encodedCodePoints =
                            percentEncode(it.toString(), PERCENT_ENCODE_SET_USERINFO)
...
internal const val PERCENT_ENCODE_SET_C0 =
    "" // this set membership is tested with (c <= '\u001f' || c > '~')
...
private fun percentDecode(input: String): String {
    fun isEncodingByte(byte: Byte?): Boolean {
        return byte != null && byte.toInt()
            .let { it in 0x30..0x39 || it in 0x41..0x46 || it in 0x61..0x66 }
    }
