package kmark.parser.constraints
...
open class CommonMarkdownConstraints protected constructor(
    ...
    override fun applyToNextLine(pos: LookaheadText.Position?): CommonMarkdownConstraints {
        ...
        val fillMaybeBlockquoteAndListIndents =
            fun(constraints: CommonMarkdownConstraints): CommonMarkdownConstraints {
                if (indexPrev >= prevN) {
                    return constraints
                }
    ...
    companion object {
        val BASE: CommonMarkdownConstraints =
            CommonMarkdownConstraints(IntArray(0), CharArray(0), BooleanArray(0), 0)

        const val BQ_CHAR: Char = '>'

        private fun create(
            parent: CommonMarkdownConstraints,
            newIndentDelta: Int,
            newType: Char,
            newExplicit: Boolean,
            newOffset: Int
