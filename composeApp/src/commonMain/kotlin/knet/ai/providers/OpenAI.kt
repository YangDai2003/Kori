...
object OpenAI {
    val openAIModelMap = mapOf(
        ...
        OpenAIModels.Chat.GPT4oMini.id to OpenAIModels.Chat.GPT4oMini,
        OpenAIModels.Chat.GPT4_1.id to OpenAIModels.Chat.GPT4_1,
        OpenAIModels.Chat.GPT4_1Nano.id to OpenAIModels.Chat.GPT4_1Nano,
        OpenAIModels.Chat.GPT4_1Mini.id to OpenAIModels.Chat.GPT4_1Mini,
        ...
        OpenAIModels.Chat.GPT5_1Codex.id to OpenAIModels.Chat.GPT5_1Codex,
        OpenAIModels.Chat.GPT5_2.id to OpenAIModels.Chat.GPT5_2
    )
