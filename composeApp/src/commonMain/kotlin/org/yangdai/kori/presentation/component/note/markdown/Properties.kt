...
object Properties {
     ...
     * @return 属性块的范围，如果没有属性块则返回 IntRange.EMPTY
     */
    fun String.getPropertiesLineRange(): IntRange {
        if (!this.startsWith("---")) return IntRange.EMPTY

        this.lineSequence().forEachIndexed { index, line ->
            if (line.startsWith("---")) return 0..index
        }
